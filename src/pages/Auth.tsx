...
import { Wallet, ArrowRight, Loader2, Mail, Phone, Lock, User, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="min-h-[100dvh] bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 right-0 w-[400px] h-[600px] bg-primary/[0.04] rounded-full blur-[100px]" />
        {/* Subtle grid pattern */}
        <div
      ...
      <div className="w-full max-w-[460px] mx-auto px-5 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-2">
            {mode === 'signin' ? 'Welcome back. Sign in to continue.' : 'Create your premium account.'}
          </p>
        </div>

        {/* Main Card */}
        <div className="rounded-2xl border border-border/50 bg-card/60 backdrop-blur-xl shadow-[0_8px_60px_-12px_hsl(var(--primary)/0.12)] p-6 sm:p-8 space-y-6">
